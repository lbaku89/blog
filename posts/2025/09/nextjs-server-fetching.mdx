...
## 그렇다면 Link 컴포넌트 요청 경로에 매번 query string을 다르게 주면 어떻게 될까?
...
## Server Fetching 한 데이터를 Context 에 주입하여 Client Component에서 사용하면?
...
{/* ## 그렇다면 Context의 값을 Client Component의 state에 복사하여 사용해도 동일하게 동작할까? */}
