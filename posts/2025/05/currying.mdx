...
자바스크립트에서 커링 함수의 개념을 이해하고, 커링이 코드의 재사용성과 가독성을 어떻게 향상시키는지 알아봅니다.

f-lab.kr](https://f-lab.kr/insight/understanding-currying-in-javascript)

[https://ko.javascript.info/currying-partials](https://ko.javascript.info/currying-partials)

[커링

ko.javascript.info](https://ko.javascript.info/currying-partials)
