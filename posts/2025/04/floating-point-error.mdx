...
<img src="floating-point-error-img1.webp" alt="floating point error" className="w-full" />
...
<img src="floating-point-error-img2.webp" alt="floating point error" className="w-full" />
...
<img src="floating-point-error-img3.webp" alt="floating point error" className="max-w-[550px] mx-auto" />
...
<img src="floating-point-error-img4.webp" alt="floating point error" className="max-w-[730px] mx-auto" />
